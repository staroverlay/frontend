...
export const DebuggableSettingsScopes: SettingsScopeData[] = [
  {
    id: 'twitch:ban',
    name: 'Ban',
    debuggable: true,
    topic: ['twitch:ban', 'twitch:unban'],
  },
  ...
  { id: 'twitch:prediction', name: 'Prediction', debuggable: true },
  {
    ...
    name: 'Raid',
    debuggable: true,
    topic: ['twitch:raid', 'twitch:raid_to'],
  },
  {
    id: 'twitch:channel_points',
    name: 'Channel Points',
    debuggable: true,
    topic: ['twitch:redemption'],
  },
