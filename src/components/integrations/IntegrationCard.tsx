...
export function IntegrationCard({
  ...
  return (
    <div className="p-4 rounded-xl border bg-zinc-900/40 border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all hover:border-violet-500/30 overflow-hidden relative">
      <div className="flex items-center gap-4 flex-1 min-w-0">
        {isConnected && integration?.providerAvatarUrl ? (
          <div className="relative shrink-0">
            ...
            />
            <div className={cn("absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-zinc-950 flex items-center justify-center bg-zinc-900", provider.color)}>
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-bold text-white leading-none">{provider.name}</h3>
            {isConnected ? (
              ...
              <span className="px-1.5 py-0.5 rounded border border-zinc-800 bg-zinc-900 text-zinc-500 text-[10px] font-semibold">
                Not connected
              </span>
            )}
          </div>
        ...
        {isConnected && integration ? (
          <>
            <div className="flex items-center gap-2 mr-2 border-r border-zinc-800 pr-4">
              <span className="text-xs font-medium text-zinc-400">Login Access</span>
              <button
                ...
                className={cn(
                  ...
                  integration.allowOauthLogin
                    ...
                    : "bg-zinc-700 hover:bg-zinc-600 border-transparent"
                )}
            ...
            <button
              className="p-2 border border-zinc-800 bg-zinc-900 hover:bg-zinc-800 text-zinc-400 transition-colors rounded-lg flex items-center justify-center"
            ...
            <button
              className="p-2 border border-zinc-800 bg-zinc-900 hover:bg-rose-500/10 hover:border-rose-500/30 text-zinc-400 hover:text-rose-500 transition-colors rounded-lg flex items-center justify-center"
