...
export function DeleteConfirmModal({
    ...
    return createPortal(
        ...
        >
            ...
            <div
                className="relative w-full max-w-md bg-surface-card border border-border-default rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300"
