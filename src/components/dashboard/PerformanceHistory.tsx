...
export function PerformanceHistory() {
  ...
  return (
    <div className="lg:col-span-2 p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] border border-zinc-900/50 bg-zinc-900/10 backdrop-blur-3xl min-h-[350px] md:min-h-[450px] relative overflow-hidden group transition-all duration-700 hover:border-violet-500/20">
